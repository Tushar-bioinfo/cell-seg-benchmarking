...
OUTPUT_DIR = PROJECT_ROOT / "inference" / "benchmarking" / DATASET_TAG / "cellsam"
INPUT_MANIFEST = None
WORKERS = 8
RAM_LIMIT_GB = 128
GPU_INDEX = 0
...
FLOW_NAME = "flow_1.predict_cellsam"
ORIGINAL_SCRIPT = PROJECT_ROOT / "scripts" / "02-inference" / "run_cellsam.py"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Flow 1 wrapper for CellSAM inference.")
