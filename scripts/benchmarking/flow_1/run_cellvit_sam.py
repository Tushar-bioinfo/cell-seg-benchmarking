...
OUTPUT_DIR = PROJECT_ROOT / "inference" / "benchmarking" / DATASET_TAG / "cellvit_sam"
INPUT_MANIFEST = None
WORKERS = 8
RAM_LIMIT_GB = 24
GPU_INDEX = 0
...
FLOW_NAME = "flow_1.predict_cellvit_sam"
ORIGINAL_SCRIPT = PROJECT_ROOT / "scripts" / "02-inference" / "run_cellvit_sam.py"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Flow 1 wrapper for CellViT SAM inference.")
